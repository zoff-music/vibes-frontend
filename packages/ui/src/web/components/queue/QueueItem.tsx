    ...
    >
      <article
        className={classNames(
          'group relative flex w-full min-w-0 items-center gap-2.5 rounded-2xl border border-theme bg-theme-surface transition-colors hover:border-theme-strong sm:gap-3',
