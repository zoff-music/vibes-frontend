import { Button, RemoteIcon } from '@vibes/ui/web';
import { Link, useNavigate } from 'react-router';

interface RemoteErrorViewProps {
  message: string;
  title: string;
}

export function RemoteErrorView({ message, title }: RemoteErrorViewProps) {
